...
import com.myway.models.*
import com.myway.ui.activities.*
import com.myway.ui.adapters.DashboardItemsListAdapter
import com.myway.ui.fragments.DashboardFragment
import com.myway.ui.fragments.OrdersFragment
import com.myway.ui.fragments.ProductsFragment
import com.myway.ui.fragments.SoldProductsFragment
...
class FirestoreClass {
     ...
     */
    fun getUserDetailsActivity(activity: Activity) {
    ...
    fun uploadProductDetails(activity: AddProductActivity, productInfo: Product) {
        ...
        mFireStore.collection(Constants.PRODUCTS)
                ...
                .addOnSuccessListener {
                    ...
                    mFireStore.collection(Constants.PRODUCTS)
                        .whereEqualTo("image", productInfo.image)
                        .get()
                        .addOnSuccessListener { documents ->
                            for (document in documents) {
                                mFireStore.collection(Constants.PRODUCTS).document(document.id).update("product_id",document.id)
    ...
    fun getProductsList(fragment: Fragment) {
        ...
        mFireStore.collection(Constants.PRODUCTS)
                ...
                .addOnFailureListener { e ->
                    ...
                    Log.e("Get Product List", "帶入資料發生錯誤", e)
                }
    }
    ...
    fun getAllProductsList(activity: Activity) {
        ...
        mFireStore.collection(Constants.PRODUCTS)
                ...
                .addOnFailureListener { e ->
                    ...
                    Log.e("Get Product List", "資料帶入錯誤", e)
                }
    }
    ...
    fun getDashboardItemsList(fragment: DashboardFragment) {
        ...
        mFireStore.collection(Constants.PRODUCTS)
                ...
                .addOnFailureListener { e ->
                    ...
                    fragment.hideProgressDialog()
                    Log.e(fragment.javaClass.simpleName, "賣場資料帶入錯誤", e)
                }
    }
    ...
    fun getProductDetails(activity: ProductDetailsActivity, productId: String) {
        ...
        mFireStore.collection(Constants.PRODUCTS)
                ...
                .addOnFailureListener { e ->
                    ...
                    Log.e(activity.javaClass.simpleName, "帶入產品資料發生錯誤", e)
                }
    }
    ...
    fun getCartList(activity: Activity) {
        ...
        mFireStore.collection(Constants.CART_ITEMS)
                ...
                .addOnFailureListener { e ->
                    ...
                    Log.e(activity.javaClass.simpleName, "資料帶入錯誤", e)
                }
    }
    ...
    fun getAddressesList(activity: AddressListActivity) {
        ...
        mFireStore.collection(Constants.ADDRESSES)
                ...
                .addOnFailureListener { e ->
                    ...
                    Log.e(activity.javaClass.simpleName, "帶入地址發生錯誤", e)
                }
    }
    ...
    fun getMyOrdersList(fragment: OrdersFragment) {
        mFireStore.collection(Constants.ORDERS)
                ...
                .addOnFailureListener { e ->
                    ...
                    Log.e(fragment.javaClass.simpleName, "帶入資料發生錯誤", e)
                }
    }
